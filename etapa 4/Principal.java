public class Principal{
    ...
    public static void main(String [] args){
        ...
        if (opcao == 1){
            ...
            int estoqueMax = Teclado.leInt("Digite a quantidade máxima de produtos: ");
                
            Loja loja1 = new Loja(nomeloja1, qtdfuncionarios, salarioBase, enderecoloja, dataFundacao, estoqueMax);
